...
import { getAuditLogs } from "@/lib/actions/system-admin.actions";
...
export default async function SystemAdminAuditLogsPage() {
  ...
  const logs = await getAuditLogs({ limit: 1000 }).catch(() => []);
    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-neutral-400 text-sm mt-1.5">
          Read-only, append-only records of all critical actions performed by platform system administrators.
        </p>
      </div>
